...
%         .catchSize: size of EIs. Default: 128
...
%zoomFactor = FOV_zoom8_um * 8 / field;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~isfield(PSFParameters,'defocusUpper'); PSFParameters.defocusUpper = 25; end   %25
if ~isfield(PSFParameters,'defocusLower'); PSFParameters.defocusLower = -25; end  %-25
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if exist(savePath,'dir')
    if overwriteFlag
        ...
        [psf_all,PSFParameters] = PSFsSimuGPU(pinhole_size, PSFParameters,savePath);
    else
