...
%%ELiiiiiii, 20220530
function [psf_all,PSFParameters] = PSFsSimuGPU(pinhole_size, PSFParameters,savePath)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%% preparations %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% basics
...
disp(PSFParameters.dxy);
PSFParameters.dxy = 400*1e3/1252;
%disp(PSFParameters.dxy)
...
%%%%%%%%%%%%%%%%%%%%%%%% a times large than  original pinhole %%%%%%%%%
% n_times = pinhole_size;   %1.8;%2.0% 2.5
% rLarge = n_times * PSFParameters.duringGeneration.apertureRadius_pixel;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PSFParameters.duringGeneration.aperture = Circle([PSFParameters.duringGeneration.xysize,PSFParameters.duringGeneration.xysize],[PSFParameters.duringGeneration.centrePixelIndex,PSFParameters.duringGeneration.centrePixelIndex],[0.0,rLarge]);
